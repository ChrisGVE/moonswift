...
// MoonSwift vendor note: added `: Sendable` to conform to Swift 6 strict
// concurrency. All associated value types (Bool, Int64, UInt64, Float, Double,
// String, Data, [MessagePackValue], [MessagePackValue: MessagePackValue], Int8)
// are themselves Sendable, making this a semantically correct conformance.

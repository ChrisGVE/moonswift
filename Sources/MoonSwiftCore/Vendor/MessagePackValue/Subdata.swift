...
// concurrency. All stored properties (base: Data, baseStartIndex: Int,
// baseEndIndex: Int) are Sendable value types, making this correct.

public struct Subdata: RandomAccessCollection, Sendable {
    let base: Data

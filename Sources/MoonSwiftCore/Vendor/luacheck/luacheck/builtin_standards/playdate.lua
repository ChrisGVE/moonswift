...
local playdate = {
    fields = {
        ...
        -- Easing Functions
        easingFunctions = standards.def_fields(
            "linear",
            "inQuad",
            "outQuad",
            "inOutQuad",

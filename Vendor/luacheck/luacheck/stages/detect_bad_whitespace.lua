...
function stage.run(chstate)
    ...
    for line_number = 1, num_lines do
        ...
        if line_length > 0 then
            ...
            local line_start_byte, _, trailing_ws_start_byte, line_end_byte =
                chstate.source:find(trailing_ws_pattern, line_offset)
            ...
            if trailing_ws_code ~= "611" then
                local leading_ws_start_byte, leading_ws_end_byte =
                    chstate.source:find("^[ \t\f\v]- \t[ \t\f\v]*", line_offset)
